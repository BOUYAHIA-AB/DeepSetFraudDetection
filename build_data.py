...
# load dataset from CSVs certificat et fournisseur
# extracte all features
# save chaque formulaire par ligne et le mettre dans un fichier sets.csv dans data
# save label par ligne et le mettre dans un fichier labels.csv dans data
